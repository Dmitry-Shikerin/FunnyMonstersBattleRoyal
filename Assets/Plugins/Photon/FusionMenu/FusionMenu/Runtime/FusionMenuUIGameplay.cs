namespace Fusion.Menu {
  ...
  public partial class FusionMenuUIGameplay : FusionMenuUIScreen {
    ...
    /// <summary>
    /// Copy text into clipboard, using Quantum Javascript extensions on WebGL builds.
    /// </summary>
    /// <param name="text">Text to copy</param>  
#if UNITY_WEBGL && !UNITY_EDITOR
    [System.Runtime.InteropServices.DllImport("__Internal")]
    private static extern void FusionCopyToClipboard(string text);
#else
    private static void FusionCopyToClipboard(string text) => GUIUtility.systemCopyBuffer = text;
#endif
    ...
    public override void Init() {
      ...
      if (_detectAndToggleMenuCamera) {
        _menuCamera = FindAnyObjectByType<Camera>();
      }
    }
    ...
    protected virtual void OnCopySessionPressed() {
      FusionCopyToClipboard(_codeText.text);
    }
    ...
    /// <summary>
    /// Update the usernames and toggle the UI part on/off depending on the <see cref="FusionMenuConnectionBehaviour.Usernames"/>
    /// </summary>
