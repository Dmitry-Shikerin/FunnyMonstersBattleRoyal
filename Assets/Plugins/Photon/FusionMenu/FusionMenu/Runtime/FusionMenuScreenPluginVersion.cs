namespace Fusion.Menu {
  ...
  /// <summary>
  /// The version plugin is used to format informational parts of the <see cref="FusionMenuConnectArgs"/> or <see cref="FusionMenuConnectionBehaviour"/>.
  /// </summary>
  public class FusionMenuScreenPluginVersion : FusionMenuScreenPlugin {
    ...
    /// <summary>
    /// Format a version string from the <see cref="FusionMenuConnectArgs"/>.
    /// </summary>
    ...
    /// <summary>
    /// Format a version string from the <see cref="FusionMenuConnectionBehaviour"/>.
    /// </summary>
