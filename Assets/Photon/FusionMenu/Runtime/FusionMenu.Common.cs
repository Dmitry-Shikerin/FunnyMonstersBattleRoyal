...
namespace Fusion.Menu {
  ...
  public partial class FusionMenuConnectArgs {
    ...
    /// </summary>
    public FusionMenuSceneInfo Scene {
      get => _scene;
      set {
        _scene = value;
    ...
    private FusionMenuSceneInfo _scene;
    ...
    /// Will run <see cref="SetDefaults(FusionMenuConfig)"/> if config is set.
    /// </summary>
    /// <param name="keyPrefix">Player prefs key prefix</param>
...
namespace Fusion.Menu {
  ...
  public abstract partial class FusionMenuConnectionBehaviour : FusionMonoBehaviour {
    ...
    /// <summary>
    /// Connect using <see cref="FusionMenuConnectArgs"/>.
    /// </summary>
...
namespace Fusion.Menu {
  ...
  public partial class FusionMenuGraphicsSettings {
    ...
    /// -1 = platform default
    /// </summary>
    protected static int[] PossibleFramerates;
    ...
    private static void ResetStaticFields() {
      PossibleFramerates = new int[] { -1, 30, 60, 75, 90, 120, 144, 165, 240, 360 };
    }
...
namespace Fusion.Menu {
  ...
  public abstract class FusionMenuUIScreen : FusionMonoBehaviour {
    ...
    /// <summary>
    /// The menu config, assigned by the <see cref="FusionMenuUIController"/>.
    /// </summary>
    public FusionMenuConfig Config { get; set; }
    /// <summary>
    /// The menu connection object, The menu config, assigned by the <see cref="FusionMenuUIController"/>.
    /// </summary>
    ...
    /// <summary>
    /// The screen init method is called during <see cref="FusionMenuUIController.Awake()"/> after all screen have been assigned and configured.
    /// </summary>
