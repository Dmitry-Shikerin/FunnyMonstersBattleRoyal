...
{
    public class GloveSkinChangerModule : EntityModule
    {
        ...
        private GloveSkinName _currentSkinName = GloveSkinName.Glove01;
        ...
        private void SetNextSkin()
        {
            ...
            if (_currentIndex >= Enum.GetValues(typeof(GloveSkinName)).Length)
                _currentIndex = 1; // Зацикливаем
        
            _currentSkinName = (GloveSkinName)_currentIndex;
            _nameText.text = _currentSkinName.ToString();
            Entity.GetCharacterSkinChangerModule().Value.SetGloveSkin(_currentSkinName);
        }
        ...
        private void SetPreviousSkin()
        {
            ...
            if (_currentIndex <= 0)
                _currentIndex = Enum.GetValues(typeof(GloveSkinName)).Length - 1; // Зацикливаем
