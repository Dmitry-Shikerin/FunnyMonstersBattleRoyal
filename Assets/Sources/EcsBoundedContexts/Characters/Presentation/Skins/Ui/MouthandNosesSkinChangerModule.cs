...
{
    public class MouthandNosesSkinChangerModule : EntityModule
    {
        ...
        private MouthandNosesSkinName _currentSkinName = MouthandNosesSkinName.Mouth01;
        ...
        private void SetNextSkin()
        {
            ...
            if (_currentIndex >= Enum.GetValues(typeof(MouthandNosesSkinName)).Length)
                _currentIndex = 1; // Зацикливаем
        
            _currentSkinName = (MouthandNosesSkinName)_currentIndex;
            _nameText.text = _currentSkinName.ToString();
            Entity.GetCharacterSkinChangerModule().Value.SetMouthandNosesSkin(_currentSkinName);
        }
        ...
        private void SetPreviousSkin()
        {
            ...
            if (_currentIndex <= 0)
                _currentIndex = Enum.GetValues(typeof(MouthandNosesSkinName)).Length - 1; // Зацикливаем
