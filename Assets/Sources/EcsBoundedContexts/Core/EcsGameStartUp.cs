...
using Sources.EcsBoundedContexts.BurnAbilities.Domain;
...
namespace Sources.EcsBoundedContexts.Core
{
    public class EcsGameStartUp : IEcsGameStartUp
    {
        ...
        private void AddOneFrame()
        {
            ...
            _systems.DelHere<WaveCompletedEvent>();
            ...
            _systems.DelHere<SpawnCharactersEvent>();
            ...
            _systems.DelHere<IncreaseHealthBoosterEvent>();
