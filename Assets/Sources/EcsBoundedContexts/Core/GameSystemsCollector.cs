...
namespace Sources.EcsBoundedContexts.Core
{
	public class GameSystemsCollector : ISystemsCollector
	{
		...
		public GameSystemsCollector(
			...
			CharacterSpawnerLoadSystem characterSpawnerLoadSystem, //Order: 0 //Ability
			EnemySpawnerLoadSystem enemySpawnerLoadSystem, //Order: 1 //Ability
			EnemySpawnSystem enemySpawnSystem, //Order: 2 //Ability
			...
			NukeAbilityLoadSystem nukeAbilityLoadSystem, //Order: 11 //Ability
			KillEnemyCounterLoadSystem killEnemyCounterLoadSystem, //Order: 12 //Common
			HealthBusterLoadSystem healthBusterLoadSystem, //Order: 13 //Common
			FlamethrowerAbilityLoadSystem flamethrowerAbilityLoadSystem, //Order: 14 //Ability
			DailyRewardLoadSystem dailyRewardLoadSystem, //Order: 15 //Common
			TreeSwingInitSystem treeSwingInitSystem, //Order: 16 //Ability
			BunkerLoadSystem bunkerLoadSystem, //Order: 16 //Common
			...
			CharacterSpawnSystem characterSpawnSystem, //Order: 57 //Ability
			MoveAlongPathSystem moveAlongPathSystem, //Order: 58 //Light
			NukeAbilitiesSystem nukeAbilitiesSystem, //Order: 59 //Ability
			...
			FlamethrowerAbilitySystem flamethrowerAbilitySystem, //Order: 66 //Ability
			GameCompletedSystem gameCompletedSystem, //Order: 67 //Common
			GameOverSystem gameOverSystem, //Order: 68 //Common
			HealthBusterSystem healthBusterSystem, //Order: 69 //Common
			BunkerDamageSystem bunkerDamageSystem, //Order: 70 //Common
			...
			TreeSwingerSystem treeSwingerSystem, //Order: 77 //Ability
			...
			SaveAfterWaveSystem saveAfterWaveSystem, //Order: 86 //Ability
			AllAbilitiesUsedAchievementSystem allAbilitiesUsedAchievementSystem, //Order: 450 //Achievements
			FiftyWaveCompletedAchievementSystem fiftyWaveCompletedAchievementSystem, //Order: 451 //Achievements
			FirstEnemyKillAchievementSystem firstEnemyKillAchievementSystem, //Order: 452 //Achievements
			FirstHealthBoosterUsageAchievementSystem firstHealthBoosterUsageAchievementSystem, //Order: 453 //Achievements
			FirstUpgradeAchievementSystem firstUpgradeAchievementSystem, //Order: 454 //Achievements
			FirstWaveCompletedAchievementSystem firstWaveCompletedAchievementSystem, //Order: 455 //Achievements
			...
			NukeAbilitySaveSystem nukeAbilitySaveSystem, //Order: 505 //Ability
			KillEnemyCounterSaveSystem killEnemyCounterSaveSystem, //Order: 506 //Common
			HealthBusterSaveSystem healthBusterSaveSystem, //Order: 507 //Common
			FlamethrowerAbilitySaveSystem flamethrowerAbilitySaveSystem, //Order: 508 //Ability
			EnemySpawnerSaveSystem enemySpawnerSaveSystem, //Order: 509 //Ability
			DailyRewardSaveSystem dailyRewardSaveSystem, //Order: 510 //Common
			CharacterSpawnerSaveSystem characterSpawnerSaveSystem, //Order: 511 //Ability
			BunkerSaveSystem bunkerSaveSystem, //Order: 512 //Common
		...
		)
		{
			...
			{
				characterSpawnerLoadSystem, //Ability
				enemySpawnerLoadSystem, //Ability
				enemySpawnSystem, //Ability
				...
				nukeAbilityLoadSystem, //Ability
				killEnemyCounterLoadSystem, //Common
				healthBusterLoadSystem, //Common
				flamethrowerAbilityLoadSystem, //Ability
				dailyRewardLoadSystem, //Common
				treeSwingInitSystem, //Ability
				bunkerLoadSystem, //Common
				...
				characterSpawnSystem, //Ability
				moveAlongPathSystem, //Light
				nukeAbilitiesSystem, //Ability
				...
				nukeAbilitySaveSystem, //Ability
				killEnemyCounterSaveSystem, //Common
				healthBusterSaveSystem, //Common
				flamethrowerAbilitySaveSystem, //Ability
				enemySpawnerSaveSystem, //Ability
				dailyRewardSaveSystem, //Common
				characterSpawnerSaveSystem, //Ability
				bunkerSaveSystem, //Common
