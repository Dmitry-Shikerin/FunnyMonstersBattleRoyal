...
{
    public class EnemyBossEntityFactory : EntityFactory
    {
        private readonly IAssetCollector _assetCollector;
        private readonly DiContainer _container;
        private readonly IEntityPool _pool;

        public EnemyBossEntityFactory(
             ...
             container)
        {
            ...
            _pool = poolManager.GetPool<EnemyBossTag>();
        ...
        {
            EnemyBossModule resourceObject = _assetCollector.Get<EnemyBossModule>();
            EnemyBossModule module = Object.Instantiate(resourceObject);
            EntityLink link = module.GetComponent<EntityLink>();
            
            Aspect.EnemyBoss.NewEntity(out ProtoEntity entity);
            ...
            //Weapons
            GunOwnerModule gunOwnerModule = module.GetComponent<GunOwnerModule>();
            entity.AddGunOwnerModule(gunOwnerModule);
            
            //Stats
            entity.AddEnemyType(EnemyType.Boss);
            entity.AddAttackPower(4);
            entity.AddMassAttackPower(4);
            ...
            entity.AddMassAttackParticle(module.MassAttackParticle);
