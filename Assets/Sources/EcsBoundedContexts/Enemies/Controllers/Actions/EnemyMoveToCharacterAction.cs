...
namespace Sources.EcsBoundedContexts.Enemies.Controllers.Actions
{
    ...
    public class EnemyMoveToCharacterAction : ActionTask
    {
        ...
        protected override void OnExecute()
        {
            ...
            Vector3 characterPosition = _entity.GetTargetCharacter().Value.GetTransform().Value.position;
            
            if (_entity.HasTargetPoint())
                _entity.ReplaceTargetPoint(characterPosition);
            else 
                _entity.AddTargetPoint(characterPosition);
        }
