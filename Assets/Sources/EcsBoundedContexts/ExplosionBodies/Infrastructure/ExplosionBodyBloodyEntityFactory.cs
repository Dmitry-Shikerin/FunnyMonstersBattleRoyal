...
{
    public class ExplosionBodyBloodyEntityFactory : EntityFactory
    {
        private readonly IAssetCollector _assetCollector;
        private readonly IEntityPool _pool;

        public ExplosionBodyBloodyEntityFactory(
            ...
            container)
        {
            ...
            _pool = poolManager.GetPool<ExplosionBodyBloodyTag>();
        ...
        {
            ExplosionBodyBloodyModule resourceObject = _assetCollector.Get<ExplosionBodyBloodyModule>();
            ExplosionBodyBloodyModule module = Object.Instantiate(resourceObject);
            EntityLink link = module.GetComponent<EntityLink>();
            
            Aspect.ExplosionBodyBloody.NewEntity(out ProtoEntity entity);
