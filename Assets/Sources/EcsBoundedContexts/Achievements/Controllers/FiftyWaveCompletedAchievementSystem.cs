...
namespace Sources.EcsBoundedContexts.Achievements.Controllers
{
    ...
    public class FiftyWaveCompletedAchievementSystem : AchievementSystem, IProtoRunSystem, IProtoInitSystem
    {
        ...
        public FiftyWaveCompletedAchievementSystem(
        ...
        {
            AchievementId = IdsConst.FiftyWaveCompletedAchievement;
        ...
        public void Run()
        {
            ...
            {
                int waveNumber = entity.GetEnemySpawnerData().WaweIndex;
