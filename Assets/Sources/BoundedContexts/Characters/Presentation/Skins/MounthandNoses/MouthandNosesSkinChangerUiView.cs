...
{
    public class MouthandNosesSkinChangerUiView : MonoBehaviour
    {
        ...
        private MouthandNosesSkinChangerView _view;

        public void Construct(MouthandNosesSkinChangerView view)
        {
