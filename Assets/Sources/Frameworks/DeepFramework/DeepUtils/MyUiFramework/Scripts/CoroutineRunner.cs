...
namespace Sources.Frameworks.DeepFramework.DeepUtils.MyUiFramework.Scripts
{
    /// <inheritdoc />
    ...
    public class CoroutineRunner : MonoBehaviour
    {
        ...
        public static CoroutineRunner Instance
        {
            get
            {
                ...
                s_instance = FindObjectOfType<CoroutineRunner>();
                
                if (s_instance == null)
                    s_instance = new GameObject("Coroutiner", typeof(CoroutineRunner)).GetComponent<CoroutineRunner>();
